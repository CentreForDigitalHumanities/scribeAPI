...
`;
    < g className="mark-tool delete-button" transform={transform} stroke={STROKE_COLOR} strokeWidth={STROKE_WIDTH} onClick={this.destroyTool
    }>
  ...
  destroyTool() {
    this.props.tool.setState({ destroying: true }, () => {
      setTimeout(this.props.tool.props.onDestroy, DESTROY_TRANSITION_DURATION);
    });
  }
});
